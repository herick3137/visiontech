<x-filament-panels::page>
    ...
    <style>
        ...
        @media print {
            ...
            /* Garante texto escuro na impressão mesmo estando em Dark Mode */
            .dark * { 
    ...
    <div class="papel-relatorio w-full max-w-5xl mx-auto bg-white dark:bg-slate-900 px-8 py-5 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800">
        ...
        <div class="border-b-2 border-slate-200 dark:border-slate-700 pb-2 mb-3 flex justify-between items-end">
            ...
            <div class="text-right">
                <p class="text-[8px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest">Documento Oficial</p>
                <p class="text-[11px] font-bold text-slate-700 dark:text-slate-300">{{ now()->format('d/m/Y \à\s H:i') }}</p>
            </div>
        </div>

        <!-- Resumo Compacto -->
        <div class="mb-4 text-slate-600 dark:text-slate-300 text-[11px] leading-tight text-justify bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded border-l-4 border-slate-300 dark:border-slate-600">
            <p>
        ...
        <div class="grade-4-colunas mb-4">
            <div class="p-2.5 border border-slate-100 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <p class="text-[8px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total Cadastrado</p>
                <p class="text-lg font-black text-slate-800 dark:text-white mt-0.5">{{ $totalEquipamentos }}</p>
            </div>
            <div class="p-2.5 border border-emerald-100 dark:border-emerald-900/30 rounded-lg bg-emerald-50/40 dark:bg-emerald-900/20">
                <p class="text-[8px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">Equip. em Estoque</p>
                <p class="text-lg font-black text-emerald-700 dark:text-emerald-400 mt-0.5">{{ $emEstoque }}</p>
            </div>
            <div class="p-2.5 border border-orange-100 dark:border-orange-900/30 rounded-lg bg-orange-50/40 dark:bg-orange-900/20">
                <p class="text-[8px] font-bold text-orange-600 dark:text-orange-400 uppercase tracking-wider">Equip. em Manutenção</p>
                <p class="text-lg font-black text-orange-700 dark:text-orange-400 mt-0.5">{{ $emManutencao }}</p>
            </div>
            <div class="p-2.5 border border-blue-100 dark:border-blue-900/30 rounded-lg bg-blue-50/40 dark:bg-blue-900/20">
                <p class="text-[8px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">Equip. em Uso (Campo)</p>
        ...
        <div class="grade-4-colunas mb-4">
            <div class="p-2.5 border border-slate-100 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <p class="text-[8px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total de Sondas</p>
                <p class="text-lg font-black text-slate-800 dark:text-white mt-0.5">{{ $totalSondas }}</p>
            </div>
            <div class="p-2.5 border border-red-100 dark:border-red-900/30 rounded-lg bg-red-50/40 dark:bg-red-900/20">
                <p class="text-[8px] font-bold text-red-600 dark:text-red-400 uppercase tracking-wider">Sondas em Manut.</p>
                <p class="text-lg font-black text-red-700 dark:text-red-400 mt-0.5">{{ $sondasManutencao }}</p>
            </div>
            <div class="p-2.5 border border-slate-100 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <p class="text-[8px] font-bold text-indigo-500 dark:text-indigo-400 uppercase tracking-wider">Movimentações Totais</p>
                <p class="text-lg font-black text-slate-800 dark:text-white mt-0.5">{{ $totalMovimentacoes }}</p>
            </div>
            <div class="p-2.5 border border-slate-100 dark:border-slate-800 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                <p class="text-[8px] font-bold text-purple-500 dark:text-purple-400 uppercase tracking-wider">Movimentações (30 Dias)</p>
        ...
        <div class="grade-4-colunas mb-4">
            @forelse($equipePorCargo as $cargo)
                <div class="p-2 border border-slate-100 dark:border-slate-800 rounded-lg flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30">
                    <span class="text-[9px] font-bold text-slate-500 dark:text-slate-400 uppercase truncate pr-1">
            ...
            @empty
                <div class="p-2 text-center text-[10px] text-slate-400 dark:text-slate-500 border border-dashed border-slate-200 dark:border-slate-700 rounded-lg" style="grid-column: 1 / -1;">
        ...
        <div class="border-t border-slate-100 dark:border-slate-800 mt-4 pt-2 text-center">
            <p class="text-[8px] text-slate-400 dark:text-slate-500 font-semibold uppercase tracking-widest">
